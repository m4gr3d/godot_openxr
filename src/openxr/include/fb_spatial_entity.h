...
#error "unknown experimental version number for XR_FB_spatial_entity_EXPERIMENTAL_VERSION"
#endif

#define XR_FB_spatial_entity 1
#define XR_FB_spatial_entity_SPEC_VERSION 2
#define XR_FB_SPATIAL_ENTITY_EXTENSION_NAME "XR_FBX1_spatial_entity"
...
// query info
typedef enum XrSpatialEntityTypeFB {
    XR_SPATIAL_ENTITY_TYPE_INVALID_FB = 0,
    XR_SPATIAL_ENTITY_TYPE_SPATIAL_ANCHOR_FB = 1,
    XR_SPATIAL_ENTITY_TYPE_MAX_ENUM_FB = 0x7FFFFFFF
} XrSpatialEntityTypeFB;

// Spatial Entity Uuid
#define XR_UUID_SIZE_FB 2
typedef struct XrSpatialEntityUuidFB {
    XrSpatialEntityTypeFB uuidType;
